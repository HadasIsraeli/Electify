...
describe('Blockchain', () => {
    ...
    describe('isValidChain()', () => {
        ...
        describe('when the chain starts with the genesis block and has multiple blocks', () => {
            beforeEach(() => {
                blockchain.addBlock({ data: 'nothing1' });
                blockchain.addBlock({ data: 'nothing2' });
                blockchain.addBlock({ data: 'nothing3' });
    ...
    describe('replaceChain()', () => {
        ...
        describe('when the new chain is longer', () => {
            beforeEach(() => {
                newChain.addBlock({ data: 'nothing1' });
                newChain.addBlock({ data: 'nothing2' });
                newChain.addBlock({ data: 'nothing3' });
    ...
    describe('validTransactionData()', () => {
        ...
        describe('and the transaction data has at least one malformed outputMap', () => {
            ...
            describe('and the transaction is a reward transactio', () => {
                it('returns false and logs an error', () => {
